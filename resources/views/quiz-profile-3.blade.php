            ...
            <div class="mt-20 ml-16">
                ...
                <div class="relative h-72 border shadow-lg rounded-3xl grid grid-cols-4 gap-4">
                    ...
                    <div class="w-full h-full col-span-3 py-8 pr-8 flex flex-col justify-between">
                            ...
                            <div class="flex flex-col basis-1/2">
                                ...
                                <div class="mt-6 flex flex-col gap-y-4">
                                    <div class="flex gap-x-2 items-center">
                                        <svg class="fill-green-600 w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                ...
                                <div class="mt-6 flex flex-col gap-y-4">
                                    <div class="flex gap-x-2 items-center">
                                        <span class="text-lg font-bold">
                                            Баллов набрано: <span class="text-accent text-xl">10</span> из <span>10</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col gap-y-4 w-full text-nowrap gap-x-8 basis-1/2 justify-center">
                                ...
                                <div class="flex w-full flex-col gap-y-2">
                                    ...
                                    <div class="flex w-full h-4 bg-gray-200 rounded-full overflow-hidden"
                                        ...
                                        aria-valuemax="100">
                                        <div class="flex flex-col justify-center rounded-full overflow-hidden bg-accent font-bold text-xs text-white text-center whitespace-nowrap transition duration-500"
                        ...
                        <a href="/quiz-results"
                            class="self-end w-fit bg-white border border-accent text-accent font-bold rounded-lg py-2 hover:bg-accent hover:text-white px-6 hover:cursor-pointer">Посмотреть
                            результаты</a>
                    </div>
                </div>
            </div>
