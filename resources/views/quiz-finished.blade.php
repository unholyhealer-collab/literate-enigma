...
<body class="w-full h-[calc(100vh-64px)] bg-white font-inter text-primary">
    ...
    <section class="container mx-auto mt-12">
        ...
        <div class="border shadow-lg rounded-2xl py-6 px-12 mt-12 flex flex-col items-center">
                ...
                <svg class="w-12 h-12" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <path
                            ...
                            fill="#fffde7" opacity=".44"> </path>
                        <linearGradient id="IconifyId17ecdb2904d178eab14761" gradientUnits="userSpaceOnUse"
                            x1="74.384" y1="61.839" x2="44.617" y2="79.699">
                        ...
                        <path
                            ...
                            fill="url(#IconifyId17ecdb2904d178eab14761)"> </path>
                        <path
                        ...
                        <path
                            ...
                            fill="#c92b27"> </path>
                        <g>
                            <path fill="#ffc107" d="M31.53 48.64l-10.34-5.07l5.15-7.44l8.11 5.37z"> </path>
                        </g>
                        <g>
                            <path
                        ...
                        <path fill="#f44336" d="M93.099 63.331l5.78 6.609l-6.609 5.78l-5.78-6.609z"> </path>
                    </g>
                </svg>
                <span class="text-2xl font-bold">Поздравляем с прохождением олимпиады!</span>
            </div>
            <div class="mt-6 pl-16 flex flex-col gap-y-6">
                <span class="text-lg">Теперь вы можете вернуться в личный кабинет</span>
                <a href="/account-3"
                    class="self-center w-fit bg-white border border-accent text-accent font-bold rounded-lg py-2 hover:bg-accent hover:text-white px-6 hover:cursor-pointer">Перейти в Личный кабинет</a>
            </div>
        </div>
    </section>
</body>
